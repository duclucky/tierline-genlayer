...
- Provenance/authentication: HTTPS official Commission host/path allowlist plus
  exact page-title, four heading, and source-version marker checks on fetched text.
